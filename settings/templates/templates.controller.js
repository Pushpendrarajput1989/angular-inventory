...
templatesController.$inject = ['$scope', '$http', '$location', 'baseUrl', 'growl', '$window', '$mdDialog', '$mdMedia', '$sce', '$q', 'PagerService', '$cookies'];

function templatesController($scope, $http, $location, baseUrl, growl, $window, $mdDialog, $mdMedia, $sce, $q, PagerService, $cookies) {
    ...
    $scope.openStickerTemplateBindedDataCopy = function(id, $event) {
        ...
        $http.get(templateIdUrl).success(function(data) {
            if (data) {
                var templateData = {};
                templateData.tableStickerTemplateName = data.tableStickerTemplateName + " Copy";
        ...
        $http.get(templateIdUrl).success(function(data) {
            if (data) {
                ...
                if (data.tableStickerTemplateIsEditable == false) {
                    templateData.tableStickerTemplateName = data.tableStickerTemplateName;
                    $scope.isEditable = true;
                }
    ...
    $scope.previewSticker = function(indata) {
        ...
        console.log($scope.invoicetemplatesData);
        var data = {
            "tableStickerTemplateName": $scope.packingtemplatesData.tableStickerTemplateName,
    ...
    $scope.saveStickerTemplate = function(templateData) {
        if (!templateData) {
            ...
            var data = {
                "tableStickerTemplateName": templateData.tableStickerTemplateName,
    ...
    $scope.editStickerTemplate = function(stickerData) {
        ...
        var data = {
            "tableStickerTemplateName": $scope.stickerTemplatesData.tableStickerTemplateName,
        ...
        $http({
            method: 'PUT',
            url: baseUrl + '/omsservices/webapi/stickertemplates/' + $scope.stickertemplates.idtableStickerTemplateId,
            data: data,
            headers: {
                'Content-Type': 'application/json'
            }
